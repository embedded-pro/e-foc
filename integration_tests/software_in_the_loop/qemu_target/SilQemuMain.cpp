...
namespace
{
    struct NoOpLowPriorityInterrupt
        : foc::LowPriorityInterrupt
    {
    ...
    void RunBenchmark(foc::TorqueCascade& torque, foc::SpeedCascade& speed, foc::PositionCascade& position, hal::cortex::DataWatchpointAndTrace& dwt)
    {
...
int main()
{
    ...
    RunBenchmark(torque, speed, position, dwt);
