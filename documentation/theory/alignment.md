...
attracted to this angle and settles there from whatever starting position it holds. This approach is
sufficient for surface-mounted PMSM and BLDC motors used in this system, where the stable equilibrium
at $\theta_e = 0$ is unique and the rotor can reach it from any initial position without risk of
converging to the wrong equilibrium.
...
is detected by a **position-change threshold window**:
