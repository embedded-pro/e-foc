...
namespace
{
    ...
    public:
        ...
        infra::Function<void(std::optional<services::ElectricalParametersIdentification::ResistanceInductanceResult>)> capturedResistanceCb;
        ...
        void CompleteCalibration_Torque()
        {
            ...
            capturedResistanceCb(services::ElectricalParametersIdentification::ResistanceInductanceResult{ foc::Ohm{ 0.5f }, foc::MilliHenry{ 1.0f }, foc::Volts{ 0.0f }, 0.0f });
