...
namespace application
{
    ...
    public:
        ...
        void Start(services::CalibrationData& pendingData, const infra::Function<void(foc::Radians)>& onAlignmentDone, const infra::Function<void()>& onFailed);
        void StartAlignmentOnly(services::CalibrationData& pendingData, const infra::Function<void(foc::Radians)>& onAlignmentDone, const infra::Function<void()>& onFailed);
