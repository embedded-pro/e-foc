...
TEST_F(TestFocController, RegisteredObserverIsInvokedForEveryPhaseCurrentsSample)
{
    ...
    EXPECT_CALL(controller, Calculate(_, _)).WillOnce(Return(foc::PhasePwmDutyCycles{ hal::FractionalPercent{ 50.0f }, hal::FractionalPercent{ 50.0f }, hal::FractionalPercent{ 50.0f } }));
