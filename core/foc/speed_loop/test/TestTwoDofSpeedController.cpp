...
namespace
{
    ...
    foc::SpeedLoopTunings TuningsWithReferenceTimeConstant(float referenceTimeConstant)
    {
    ...
    {
    public:
        foc::TwoDofSpeedController controller;
    };
}
...
TEST_F(TestTwoDofSpeedController, pre_filter_softens_a_setpoint_step)
{
    ...
    foc::PidSpeedController withoutPreFilter;
    withoutPreFilter.Configure(ValidParameters());

    const foc::SpeedControlContext step{ foc::RadiansPerSecond{ 0.0f }, foc::RadiansPerSecond{ 1.0f } };
...
TEST_F(TestTwoDofSpeedController, a_longer_time_constant_slows_the_reference_further)
{
    ...
    foc::TwoDofSpeedController responsive;
