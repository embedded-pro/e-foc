...
namespace application
{
    ...
    TerminalInteractor::StatusWithMessage TerminalInteractor::SetPwmDuty(const infra::BoundedConstString& param)
    {
        ...
        hardware.ThreePhasePwmOutput(foc::PhasePwmDutyCycles{ hal::FractionalPercent{ static_cast<float>(*dutyA) }, hal::FractionalPercent{ static_cast<float>(*dutyB) }, hal::FractionalPercent{ static_cast<float>(*dutyC) } });
