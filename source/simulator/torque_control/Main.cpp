...
int main(int argc, char* argv[], const char* env[])
{
    ...
    args::Positional<float> currentSetPointArgument(positionals, "currentSetPoint", "current set point for the simulation (in Amperes) [default = 0.1 A]", 0.1f, args::Options::Single);
    ...
    try
    {
        ...
        simulator::Plot plotter{ model, "FOC Torque Control", "foc_torque_results", timeStep, simulationTime };
