...
int main(int argc, char* argv[])
{
    ...
    try
    {
        ...
        if (enableGui)
        {
            ...
            simulator::GuiSimulation simulation{ argc, argv, model, controller, eventDispatcher, simulator::JK42BLS01_X038ED::parameters, pidParameters, positionSetpointConfig, foc::Volts{ powerSupplyVoltage } };
